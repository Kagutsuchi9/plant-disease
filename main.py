...
option = st.sidebar.selectbox("Select Page", ["Home", "About", "Disease Recognition"])
...
if option == "Home":
    ...
    ### Cara Penggunaan
    1. **Upload Image:** Buka Halaman **Disease Recognition** dan pilih gambar tanaman yang dicurigai terkena penyakit.
    2. **Predict:** Aplikasi akan memproses gambar menggunakan algoritma canggih untuk mengidentifikasi potensi penyakit.
    3. **Results:** Lihat hasil dan rekomendasi untuk tindakan lebih lanjut.

    ### Mulai Sekarang
    Klik pada halaman **Disease Recognition** di sidebar untuk mengunggah gambar dan rasakan kekuatan Sistem Pengenalan Penyakit Tanaman!

    ### Tentang Plant Disease Recognition
    Pelajari lebih lanjut tentang project penulis di halaman **About**.
    """)
...
# About page
    ...
    st.markdown("""
    ### Mengapa Memilih Plant Disease Recognition?
    ...
    #### Dataset
    Dataset ini dibuat ulang menggunakan augmentasi offline dari dataset asli, dataset asli dapat ditemukan di repositori GitHub Capstone Project Penulis, [Klik untuk melihat](https://github.com/Flora-Vista-Bangkit-Capstone/ML-AI/tree/main/DATASET/PENYAKIT).

    Dataset ini terdiri dari sekitar 4500 gambar rgb daun tanaman yang terkena penyakit yang dikategorikan ke dalam 15 kelas yang berbeda,
    total dataset dibagi menjadi rasio 70/20 untuk set pelatihan dan validasi untuk menjaga struktur direktori. Kemudian pengujian dengan 3 gambar dari link url gambar daun dari internet.
    #### Content
    1. train (3150 gambar)
    2. test (450 gambar)
...
# Disease Recognition page
elif option == "Disease Recognition":
    ...
    if uploaded_file is not None:
        ...
        if st.session_state.prediction_result:
            ...
            st.write("**Akurasi Prediksi:**", f"{prediction_result['data']['skorKepercayaan']:.2f}%")
